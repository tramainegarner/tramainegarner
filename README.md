...
I’m a **multidisciplinary Full-Stack Developer and Designer** with a background in **Information Technology**, based in Toronto, Canada. I design, create, and develop purposeful projects that prioritize people, problems, and the connections between them. With years of experience, I can help you achieve your project’s goals across **web applications**, **digital products**, **and print media.**

![My Profile Picture](https://github.com/tramainegarner/tramainegarner/blob/main/TramaineGarner_FullStackDeveloper.png)

Bridging technology, development, and design, my diverse background allows me to apply these areas to projects of any scale. To see this approach in action, explore my codebases below, and visit my portfolio at [https://www.tramainegarner.dev](https://www.tramainegarner.dev) for a closer look at my design work.
...
- **Adobe CC:** Acrobat, After Effects, Animate, Audition, Dimension, Dreamweaver, Illustrator, InDesign, Lightroom, Photoshop, Premiere Pro
...
- **DesignOps:** Workflows, Documentation, Collaboration, Handoffs
...
- **Microsoft Office Tools:** Access, Excel, OneNote, Outlook, PowerPoint, Word
